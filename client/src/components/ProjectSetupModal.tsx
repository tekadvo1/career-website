...
export default function ProjectSetupModal({ isOpen, onClose, project, role }: ProjectSetupModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center sm:p-6" style={{ background: 'rgba(15, 23, 42, 0.70)', backdropFilter: 'blur(8px)' }}>
      <div className="bg-white rounded-none sm:rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] w-full max-w-4xl overflow-hidden flex flex-col h-full sm:h-auto max-h-none sm:max-h-[92vh] animate-in zoom-in-95 duration-200 border-0 sm:border border-slate-200/50">
