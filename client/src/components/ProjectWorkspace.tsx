                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                         ...
                         <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
                             <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6 flex items-center gap-2">
                                 <BarChart className="w-4 h-4" /> Weekly Velocity
                             </h3>
                             <div className="space-y-4">
                                 <div>
                                     <div className="flex justify-between text-sm mb-2">
                                         <span className="text-gray-300">Tasks Completed</span>
                                         <span className="font-bold text-white">{tasksCompletedToday} / {tasksTargetToday}</span>
                                     </div>
                                     <div className="w-full bg-gray-800 h-2 rounded-full overflow-hidden">
                                         <div className="h-full bg-emerald-500 rounded-full" style={{ width: `${dailyProgress}%` }}></div>
                                     </div>
                                 </div>
                                 <div className="p-3 bg-gray-800/50 rounded-xl border border-gray-800 flex items-center justify-between">
                                     <span className="text-xs text-gray-400">Current Streak</span>
                                     <div className="flex items-center gap-1.5 text-amber-500 font-bold">
                                         <Zap className="w-4 h-4 fill-amber-500" /> 3 Days
                                     </div>
                                 </div>
                             </div>
                         </div>
                             ...
                             <div className="flex gap-4 items-start">
                                 ...
                                 <div className="flex-1">
                                     <div className="bg-gray-800 rounded-xl rounded-tl-none p-4 text-sm text-gray-300 leading-relaxed mb-4">
                                         "You have <strong>{currentTask?.duration || "45m"}</strong> scheduled for today. Completing this module will boost your <strong>Backend Systems</strong> skill by 12%. Ready to code?"
                                     </div>
